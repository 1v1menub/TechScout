    ...
    <Routes>
      ...
      <Route path="/productpagemain" element={
                                      <div className='testcont'>
                                        <ProductPageMain name="Asus Laptop-God 5000 16''" rating={4.5} price={4995.00} dtime={"5-6"} images={["https://www.pcworld.com/wp-content/uploads/2022/06/razer-laptop.jpg?quality=50&strip=all", "https://www.techspot.com/articles-info/1090/images/2021-07-28-image.jpg", "https://wallpaperset.com/w/full/f/0/1/461126.jpg"]}  tags={["GAMER", "DISEÑO"]} specs={["16GB RAM", "HDMI", "RTX 3060", "1TB SSD"]}/>
